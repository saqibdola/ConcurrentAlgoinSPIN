...
\author{\IEEEauthorblockN{M. Saqib Nawaz$^1$, Hussam Ali$^2$ and M. IkramUllah Lali$^3$} 
\IEEEauthorblockA{$^1$Department of Information Science, School of Mathematical Sciences, Peking University, Beijing, China}
\IEEEauthorblockA{$^2$Department of Computer Science, COMSATS Institute of Information Technology, Wah-Cantt, Pakistan}
\IEEEauthorblockA{$^3$Department of Computer Science \& IT, University of Sargodha, Sargodha, Pakistan\\msaqibnawaz@pku.edu.cn,
...
\centering\includegraphics[width=0.3\textwidth]{3n}
...
\begin{figure}[!ht]
\centering\includegraphics[width=0.5\textwidth]{dekkermodel}
